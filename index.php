...
<head>
    ...
    <meta name="google-signin-client_id" content="954432276682-oc0iaf0uncrditdhj5d3dbbp2bcn0ns0.apps.googleusercontent.com">
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v4.0&appId=542271436542069&autoLogAppEvents=1"></script>
</head>
<body>
<!--Preloader-->
                ...
                <div style="height:50px;width:240px;" class="abcRioButton abcRioButtonBlue">
                    <div class="abcRioButtonContentWrapper">
                        ...
                        <span style="font-size:16px;line-height:48px;" class="abcRioButtonContents">
                            <span id="not_signed_inh9d86cjsnxs4">Continue with Google</span>
                            <span id="connectedh9d86cjsnxs4" style="display:none">Continue with Google</span>
                        </span>
                    </div>
                </div>
            </div>
            
            <div class="fb-login-button" data-width="20px" data-size="medium" data-button-type="continue_with" data-auto-logout-link="false" data-use-continue-as="false">
            </div>
            <div>
